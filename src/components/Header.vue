      ...
      <div class="flex items-center justify-between h-20">
        ...
        <nav class="hidden md:flex md:flex-grow">
          ...
          <ul class="flex flex-grow flex-wrap items-center font-medium">
            <li>
              <router-link to="/about" class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out">درباره من</router-link>
            </li>
            <li>
              <router-link to="/blog" class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out">وبلاگ</router-link>
            </li>
            <!-- <li>
          ...
          <ul class="flex justify-end flex-wrap items-center">
            <li>
              <router-link to="/contact" class="btn-sm text-white bg-teal-500 hover:bg-teal-400 ml-6">دریافت رزومه</router-link>
            </li>
          </ul>
