          ...
          <div class="lg:flex-grow" data-aos="fade-down" data-aos-delay="200">
            ...
            <div class="grid gap-12 sm:grid-cols-2 sm:gap-x-6 md:gap-y-8 items-start">
              ...
              <article class="flex flex-col h-full">
                ...
                <footer class="flex items-center mt-4">
                  <a href="#0">
                    <img class="rounded-full flex-shrink-0 mr-3" src="../images/news-author-06.jpg" width="32" height="32" alt="Author 06" />
                  </a>
                  <div class="text-sm text-gray-500">
              ...
              <article class="flex flex-col h-full">
                ...
                <footer class="flex items-center mt-4">
                  <a href="#0">
                    <img class="rounded-full flex-shrink-0 mr-3" src="../images/news-author-01.jpg" width="32" height="32" alt="Author 01" />
                  </a>
                  <div class="text-sm text-gray-500">
              ...
              <article class="flex flex-col h-full">
                ...
                <footer class="flex items-center mt-4">
                  <a href="#0">
                    <img class="rounded-full flex-shrink-0 mr-3" src="../images/news-author-04.jpg" width="32" height="32" alt="Author 04" />
                  </a>
                  <div class="text-sm text-gray-500">
              ...
              <article class="flex flex-col h-full">
                ...
                <footer class="flex items-center mt-4">
                  <a href="#0">
                    <img class="rounded-full flex-shrink-0 mr-3" src="../images/news-author-05.jpg" width="32" height="32" alt="Author 05" />
                  </a>
                  <div class="text-sm text-gray-500">
